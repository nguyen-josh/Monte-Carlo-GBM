...
along with nominal and inflation-adjusted percentile bands. The original, simpler version built in R/Shiny that was converted to Python and improved to a Markov model is also included.
